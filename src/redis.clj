...
(defcommands
  ...
  (zcard       [key] :inline)
  (zcount      [key min max] :inline)
  (zincrby     [key increment member] :bulk string-to-double)
  (zinterstore [dest num-key & opts] :inline)
  (zrange      [key start end & options] :inline)
  (zrank       [key member] :inline)
  (zrangebyscore    [key start end] :inline)
  (zrem             [key member] :bulk int-to-bool)
  (zremrangebyrank  [key start end] :inline)
  (zremrangebyscore [key start end] :inline)
  (zrevrange        [key start end & options] :inline)
  (zrevrangebyscore [key start end & options] :inline)
  (zrevrank         [key member] :inline)
